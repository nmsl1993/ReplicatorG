...
ToolpathGenerator.GeneratorListener
{
	...
	protected JMenu buildGCodeMenu() {
		...
		supportDualItem = new JMenuItem("Dual-Material Support");
		supportDualItem.addActionListener(new ActionListener()
		{
